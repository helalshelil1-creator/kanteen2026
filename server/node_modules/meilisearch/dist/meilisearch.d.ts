...
import type { KeyCreation, Config, IndexOptions, IndexObject, Key, Health, Stats, Version, KeyUpdate, IndexesQuery, IndexesResults, KeysQuery, KeysResults, IndexSwap, MultiSearchParams, FederatedMultiSearchParams, MultiSearchResponseOrSearchResponse, EnqueuedTask, EnqueuedTaskPromise, ExtraRequestInit, Network, RecordAny, RuntimeTogglableFeatures, ResourceResults, SearchRule, SearchRuleUpdatePayload, SearchRuleListPayload, Webhook, ResultsWrapper, WebhookCreatePayload, WebhookUpdatePayload, InitializeNetworkOptions, AddRemoteOptions, RemoveRemoteOptions, UpdateNetworkOptions, RenderTemplateParams, RenderTemplateResponse, ChatWorkspaceObject, ChatWorkspacesQuery, ChatWorkspacesResults } from "./types/index.js";
...
export declare class Meilisearch {
     ...
     */
    getChatWorkspaces(parameters?: ChatWorkspacesQuery): Promise<ChatWorkspacesResults>;
    /**
     ...
     */
    getChatWorkspace(workspace: string): Promise<ChatWorkspaceObject>;
    /**
     ...
     */
    deleteChatWorkspace(workspace: string): Promise<void>;
    /**
